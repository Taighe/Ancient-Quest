...
namespace AQEngine.Animators
{
    public class KinematicAnimator : AnimatorController
    {
        ...
        public override bool UpdateAnimations()
        {
            ...
            Quaternion to = !_animEvents.NoFaceDirection ? Quaternion.Euler(0, (float)_kinematicObj.Direction, 0) : 
                Quaternion.Euler(0, (float)Direction.FRONT, 0);
